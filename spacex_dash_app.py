...
for label in spacex_df['Launch Site'].unique():
...
def get_scatter_chart(entered_site, entered_payload_range):
  if entered_site=='ALL':
    min_entered_payload = entered_payload_range[0]
    max_entered_payload = entered_payload_range[1]
    filtered_df = spacex_df
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)']>min_entered_payload]
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)']<max_entered_payload]
